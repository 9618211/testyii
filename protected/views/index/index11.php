...
<div id="body-wrapper">
    ...
    <div id="sidebar-wrapper">
      ...
      <ul id="main-nav">
        ...
        <li> <a href="#" class="nav-top-item"> 其它管理 </a>
          <ul>
          <?php echo Yii::app()->request->baseUrl."hwllo";?>
            <li><a href="#">城区管理</a></li>
            <li><a href="#">建筑高度</a></li>
            <li><a href="#">建筑结构</a></li>
  ...
  <div id="main-content">
    ...
    <ul class="shortcut-buttons-set">
      <li><a class="shortcut-button" href="#"><span> <img src="/statics/images/index/icons/pencil_48.png" alt="icon" /><br />
        Write an Article </span></a></li>
      <li><a class="shortcut-button" href="#"><span> <img src="/statics/images/index/icons/paper_content_pencil_48.png" alt="icon" /><br />
        Create a New Page </span></a></li>
      <li><a class="shortcut-button" href="#"><span> <img src="/statics/images/index/icons/image_add_48.png" alt="icon" /><br />
        Upload an Image </span></a></li>
      <li><a class="shortcut-button" href="#"><span> <img src="/statics/images/index/icons/clock_48.png" alt="icon" /><br />
        Add an Event </span></a></li>
      <li><a class="shortcut-button" href="#messages" rel="modal"><span> <img src="/statics/images/index/icons/comment_48.png" alt="icon" /><br />
          ...
          <table>
            ...
            <tbody>
              <tr>
                ...
                <td>
                  <!-- Icons -->
                  <a href="#" title="Edit"><img src="/statics/images/index/icons/pencil.png" alt="Edit" /></a> <a href="#" title="Delete"><img src="/statics/images/index/icons/cross.png" alt="Delete" /></a> <a href="#" title="Edit Meta"><img src="/statics/images/index/icons/hammer_screwdriver.png" alt="Edit Meta" /></a> </td>
              </tr>
              <tr>
                <td>
                  <input type="checkbox" />
    ...
    <div class="notification information png_bg"> <a href="#" class="close"><img src="/statics/images/index/icons/cross_grey_small.png" title="Close this notification" alt="close" /></a>
    ...
    <div class="notification success png_bg"> <a href="#" class="close"><img src="/statics/images/index/icons/cross_grey_small.png" title="Close this notification" alt="close" /></a>
    ...
    <div class="notification error png_bg"> <a href="#" class="close"><img src="/statics/images/index/icons/cross_grey_small.png" title="Close this notification" alt="close" /></a>
